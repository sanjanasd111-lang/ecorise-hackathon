...
5. **Fast Demo Mode**: In the top purple Demo Bar, click **"105 Pts (Climate Champion)"**:
   ...
   - EcoByte blossoms into its Stage 4 Golden-Green Solar Crown with star eyes.
   - The Climate Champion celebration modal opens with unlocked achievements.
6. **Analytics & Community**: Scroll to the 4-Week Trend chart (showing the live Week 4 bar) and the community goal meter (showing your actions adding to the 500-action goal).
7. **Theme Toggle & Persistence**: Toggle Dark Mode to showcase the sleek emerald-black contrast, then refresh the browser to prove everything persisted via `localStorage`.
